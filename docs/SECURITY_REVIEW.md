...
Reviewed on 2026-08-12 after adding Agent Card signing. This was a source-based
...
- The Agent Card signature covers discovery metadata only; it does not sign
