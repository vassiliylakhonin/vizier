...
```bash
npm install https://github.com/vassiliylakhonin/vizier/releases/download/v0.5.2/vizier-sdk-0.5.2.tgz
```
...
Version 0.5.2 is distributed as GitHub Release archives. The `@vizier` npm scope
