...
```bash
npm install https://github.com/vassiliylakhonin/vizier/releases/download/v0.5.0/vizier-sdk-0.5.0.tgz https://github.com/vassiliylakhonin/vizier/releases/download/v0.5.0/vizier-mcp-proxy-0.5.0.tgz
...
```bash
npm install https://github.com/vassiliylakhonin/vizier/releases/download/v0.5.0/vizier-sdk-0.5.0.tgz
```
...
Version 0.5.0 is distributed as GitHub Release archives. The `@vizier` npm scope
